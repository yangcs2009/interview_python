...
* 计算机是用来帮助人们解决实际问题的，直接操作计算机硬件比较麻烦且不安全；
* 引入操作系统可以方便的管理计算机硬件，操作系统是计算机硬件和应用之间的一层软件；
...
![分页.png](img/os/分页.png)

![分页demo.png](img/os/分页demo.png)

分页: 用户程序的地址空间被划分成若干固定大小的区域，称为“页”，相应地，内存空间分成若干个物理块，页和块的大小相等。可将用户程序的任一页放在内存的任一块中，实现了离散分配。

![分段.png](img/os/分段.png)

![分段demo.png](img/os/分段demo.png)
